...
DEPT_INFO = {
    ...
    'Gastroenterology': {
        ...
        'desc':'specislises in digestive system',
    ...
    'General Medicine': {
        ...
        'desc':'handles general helth consern and non specialist conditions',
...
st.markdown("""
<!-- COLOR1 -->
<div style="background:linear-gradient(135deg,#4a77a7 0%,#3380b7 60%,#c10cdd 100%);
            padding:3rem 2rem 2.5rem;margin:-1rem -1rem 2rem;text-align:center;">
    <div style="font-size:14px;font-weight:500;color:rgba(141, 88, 168, 0.7);
...
with st.form("triage_form"):
    ...
    st.markdown("""
    <!-- COLOR2 -->
    <div style="background:#000000;border:1px solid #000000;border-radius:14px;
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            ...
            <span style="font-size:16px;font-weight:600;color:#105efa;">what r ur sympthoms</span>
    ...
    st.markdown("""
    <!-- COLOR3 -->
    <div style="background:#f6090900;border:1px solid #a0ae00;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#000000;color:rgb(107, 0, 0);border-radius:8px;
    ...
    with col_cc:
        chief_complaint = st.selectbox("cheif chief_complaint", options=list(cc_map.keys()))
    with col_dur:
    ...
    st.markdown("""
    <!-- COLOR4 -->
    <div style="background:#000000;border:1px solid #cbdc0d;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
    ...
    st.markdown("""
    <!-- COLOR6 -->
    <div style="background:#f6f6f6;border:1px solid #cbdc0d;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
